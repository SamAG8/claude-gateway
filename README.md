...
| `MAX_FILE_SIZE` | `10485760` | Max decoded image bytes (→ 413). |
| `MAX_PDF_SIZE` | `33554432` | Max decoded PDF bytes (→ 413). |
| `MAX_PDF_PAGES` | `100` | PDFs longer than this are flattened to text on the Anthropic surface instead of sent natively. |
